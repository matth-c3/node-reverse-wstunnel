...
optimist = require('optimist').usage("\nRun websocket tunnel and reverse tunnel such server or client.\n" +
    "To run websocket tunnel server: wst.js_doRemove -s 8080\n" +
    "To run websocket tunnel client: wst.js_doRemove -t localport:host:port ws://wshost:wsport\n" +
